...
export default function R6FullProduct() {
  ...
  const [variants, setVariants] = useState<Variant[]>([
    { id: 'day', name: 'Day Key', price: 4.99, stock: 0, sellauthId: '647543' },
    { id: 'week', name: 'Week Key', price: 11.99, stock: 0, sellauthId: '647544' },
    { id: 'month', name: 'Month Key', price: 29.99, stock: 0, sellauthId: '647545' }
  ])
